  ...
  return (
    <Layout title={`${author.name} | Library Management System`}>
      <div className="max-w-4xl mx-auto p-4">
        ...
        <p className="text-lg mb-2">Nationality: {author.nationality}</p>
        <p className="text-lg mb-2">Birth Date: {author.birthdate}</p>
        <p className="text-lg mb-4">Bio: {author.bio}</p>
